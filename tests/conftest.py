    ...
    return pd.DataFrame(
        {
            ...
            "reason_description": ["Competitor Deals - No longer required"] * 40
            + ["Not Known"] * 30
            + ["Home mover"] * 30,
            "reason_description_insight": ["CompetitorDeals"] * 40
            + ["VagueReason"] * 30
            + ["HomeMove"] * 30,
        }
    )
    ...
    return pd.DataFrame(
        {
            ...
            "crm_package_name": rng.choice(
                ["Unlimited Broadband", "Essential Fibre", "Premium Fibre"], n
            ),
